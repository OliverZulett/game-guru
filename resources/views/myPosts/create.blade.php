        ...
        <div class="p-6 text-gray-900">
          <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
              {{ __("Create an amazing post about some videogame.") }}
            </p>
          </header>

          <form class="mt-5" action="{{ route('my-posts.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-4">
              ...
              <input type="text" name="image_url" id="image_url" value="{{ old('image_url') }}" class="border border-gray-300 rounded-md p-2 w-full">
            </div>
            ...
            <div class="mb-4">
              ...
              <textarea name="abstract" id="abstract" class="border border-gray-300 rounded-md p-2 w-full" rows="3">{{ old('abstract') }}</textarea>
            </div>

            <div class="mb-4">
              <label for="content" class="block text-gray-700 text-sm font-bold mb-2">{{ __("Content *") }}</label>
              <textarea name="content" id="content" class="border border-gray-300 rounded-md p-2 w-full" rows="5">{{ old('content') }}</textarea>
            </div>
