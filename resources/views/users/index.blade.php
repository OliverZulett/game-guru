      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          <div class="w-full flex justify-end mb-3">
            <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" title="Add" onclick="window.location.href='{{ route('users.create') }}'">
              + Add
            </button>
          </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <button class="text-red-500 hover:text-blue-700 mr-2" title="Delete" onclick="window.location.href='{{ route('users.destroy', $user->id) }}'">
